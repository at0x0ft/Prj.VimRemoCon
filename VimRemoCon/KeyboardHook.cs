...
{
	/// <summary>
	/// Keyboard global hook related class
	/// </summary>
	public static class KeyboardHook
	{
		...
		private static class NativeMethods
		{
			...
			/// </summary>
			/// <param name="nCode">Hook code which is given to hook procedure</param>
			/// <param name="msg">Value which is given to hook procedure</param>
			/// <param name="msllhookstruct">Value which given to hook procedure</param>
			/// <returns>Next hook procedure value in hook procedure</returns>
